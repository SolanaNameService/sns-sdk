...
void [
  ...
  address.getSolDomainsForAddress,
  address.getSolNftsForAddress,
  bindings.registerDomain,
  codecs.addressCodec,
  constants.NAME_PROGRAM_ADDRESS,
  constants.SRS_PROGRAM_ADDRESS,
  domain.resolve,
  domain.safeResolve,
  domain.getAllSolDomains,
  domain.getSolDomainAddress,
  domain.getSrsDomainAddress,
  errors.SNSError,
