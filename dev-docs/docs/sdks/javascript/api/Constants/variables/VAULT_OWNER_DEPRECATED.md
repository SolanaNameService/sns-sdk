...
[JavaScript SDK API Reference](../../index.md) / [Constants](../index.md) / VAULT\_OWNER\_DEPRECATED

# ~~Variable: VAULT\_OWNER\_DEPRECATED~~
...
Use [VAULT\_OWNER](VAULT_OWNER.md) for new integrations.
