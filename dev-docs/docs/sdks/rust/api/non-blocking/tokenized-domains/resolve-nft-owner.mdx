...
description: Find the holder of a tokenized domain mint.
---
...
Defined in: <SourceLink path="rust-crates/sns-sdk/src/non_blocking/nft.rs" line={116} label="rust-crates/sns-sdk/src/non_blocking/nft.rs:116" />
