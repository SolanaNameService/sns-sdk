...
description: Find the holder of a tokenized SNS domain mint.
---
...
Defined in: <SourceLink path="rust-crates/sns-sdk/src/blocking/nft.rs" line={103} label="rust-crates/sns-sdk/src/blocking/nft.rs:103" />
