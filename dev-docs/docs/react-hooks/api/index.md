...
| Module | Description |
| ------ | ------ |
| [Types](Types/index.md) | Shared React Query option types used by SNS hooks. |
| [usePrimaryDomain](usePrimaryDomain/index.md) | Wallet primary-domain lookup through TanStack Query. |
| [useProfilePic](useProfilePic/index.md) | Verified SNS profile-picture records through TanStack Query. |
