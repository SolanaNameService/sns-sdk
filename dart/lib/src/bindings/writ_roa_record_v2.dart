...
/// Parameters for writing Right of Association (RoA) for record V2
class WritRoaRecordV2Params {
  const WritRoaRecordV2Params({
...
/// Writes a ROA (Right of association) in a record V2.
///
/// This function mirrors js/src/bindings/writRoaRecordV2.ts
Future<TransactionInstruction> writRoaRecordV2(
  WritRoaRecordV2Params params,
) async {
